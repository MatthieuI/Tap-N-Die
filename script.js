...
/* Parametre */ 
let fermeture = document.getElementById ("fermeture");// Louise // 
let ecrou = document.getElementById ("ecrou");// Louise // 
let parametres = document.getElementById ("parametres");// Louise // 
let boutonCredits = document.getElementById ("boutonCredits");// Louise // 
let boutonReinitialiser = document.getElementById ("boutonReinitialiser"); // Louise // 

/* Crédits*/
let credits = document.getElementById ("credits")// Louise // 
let boutonRetourParametre = document.getElementById ("boutonRetourParametre");// Louise // 
...
let guerriereObjet = {
    ...
    capaciteSpeciale() {
        if (dispoCapacite===true) {
            ...
            setTimeout(fixerChronoMonstre, 5000);
            dispoCapacite = false;
            i = cooldownCapacite;
...
function selectionneMagicienne() { 
...
function acheterCoutRecrutementPerm() {   //Louise 28/01 // 
    if(gemmes >= prixCoutRecrutementPerm) {
        ...
        prixPaysan *= 0.95;// A VERIFIER // ///////////////////////////////////////////
        prixMilicien *= 0.95;// A VERIFIER // ///////////////////////////////////////////
        prixMilicien *= 0.95;// A VERIFIER // ///////////////////////////////////////////
        prixSoldat *= 0.95;// A VERIFIER // ///////////////////////////////////////////
        prixFantassin *= 0.95;// A VERIFIER // ///////////////////////////////////////////
        prixGarde *= 0.95;// A VERIFIER // ///////////////////////////////////////////
        prixGeneral *= 0.95;// A VERIFIER // ///////////////////////////////////////////
        prixPretre *= 0.95;// A VERIFIER // ///////////////////////////////////////////
        prixEnchanteresse *= 0.95;// A VERIFIER // ///////////////////////////////////////////
        prixSeigneur *= 0.95;// A VERIFIER // ///////////////////////////////////////////
...
function nouveauMonstre() {
    ...
    if (compteurMonstresTues%5===0) {
      forceMonstre = Math.round(forceMonstre*1.2);
    }
    monstreElite.style.display = "none";  
